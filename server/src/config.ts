...
export class Config {
    ...
    'jhipster.mail.from' = 'nemo1@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'nemo1 API';
    'jhipster.swagger.description' = 'nemo1 API documentation';
    ...
    'eureka.instance.appname' = 'nemo1';
    'eureka.instance.instanceId' = 'nemo1:${random.value}';
