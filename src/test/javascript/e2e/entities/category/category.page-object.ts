...
export class CategoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('nemo1App.category.delete.question'));
...
export default class CategoryComponentsPage {
  ...
  async deleteCategory() {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/nemo1App.category.delete.question/);
