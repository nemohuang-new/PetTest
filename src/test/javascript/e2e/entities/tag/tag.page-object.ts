...
export class TagDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('nemo1App.tag.delete.question'));
...
export default class TagComponentsPage {
  ...
  async deleteTag() {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/nemo1App.tag.delete.question/);
