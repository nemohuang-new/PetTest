...
export default class TagUpdatePage {
  pageTitle: ElementFinder = element(by.id('nemo1App.tag.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  nameInput: ElementFinder = element(by.css('input#tag-name'));
  petsSelect: ElementFinder = element(by.css('select#tag-pets'));
