...
export class PetDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('nemo1App.pet.delete.question'));
...
export default class PetComponentsPage {
  ...
  async deletePet() {
    ...
    expect(await petDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/nemo1App.pet.delete.question/);
