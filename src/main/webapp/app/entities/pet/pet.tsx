...
import { getEntities, reset } from './pet.reducer';
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('photoUrls')}>
                    Photo Urls <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('status')}>
                    Status <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('additionalMetadata')}>
                    Additional Metadata <FontAwesomeIcon icon="sort" />
                  </th>
              ...
              <tbody>
                {petList.map((pet, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{pet.photoUrls}</td>
                    <td>{pet.status}</td>
                    <td>{pet.additionalMetadata}</td>
                    <td>{pet.file}</td>
                    <td>{pet.inventory ? <Link to={`pet-inventory/${pet.inventory.id}`}>{pet.inventory.id}</Link> : ''}</td>
...
const mapStateToProps = ({ pet }: IRootState) => ({
  ...
  links: pet.links,
  entity: pet.entity,
  updateSuccess: pet.updateSuccess,
});
